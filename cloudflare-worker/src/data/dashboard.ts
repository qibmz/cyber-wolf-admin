  ...
  return [
    {
      ...
      group: { name: '高逼格设计天团', link: 'https://github.com/' },
      project: { name: '六月迭代', link: 'https://github.com/' },
    ...
    },
    {
      ...
      group: { name: '中二少女团', link: 'https://github.com/' },
      project: { name: '六月迭代', link: 'https://github.com/' },
      template: '在 @{group} 新建项目 @{project}',
    },
    {
      ...
      project: { name: '5 月日常迭代', link: 'https://github.com/' },
    ...
    },
    {
      ...
      project: { name: '工程效能', link: 'https://github.com/' },
      comment: { name: '留言', link: 'https://github.com/' },
    ...
    },
    {
      ...
      group: { name: '程序员日常', link: 'https://github.com/' },
      project: { name: '品牌迭代', link: 'https://github.com/' },
      template: '在 @{group} 新建项目 @{project}',
    },
  ];
}
